...
var EditableCell2 = /** @class */ (function (_super) {
    ...
    function EditableCell2() {
        ...
        _this.renderCell = function (_a) {
            ...
            if (isEditing) {
                ...
                cellContents = (React.createElement(core_1.EditableText, tslib_1.__assign({}, editableTextProps, { isEditing: true, className: classnames_1.default(Classes.TABLE_EDITABLE_TEXT, Classes.TABLE_EDITABLE_NAME, className), intent: spreadableProps.intent, minWidth: null, onCancel: _this.handleCancel, onChange: _this.handleChange, onConfirm: _this.handleConfirm, onEdit: _this.handleEdit, placeholder: "", selectAllOnFocus: false, value: dirtyValue })));
            }
            else {
                var textClasses = classnames_1.default(Classes.TABLE_EDITABLE_TEXT, (_b = {},
    ...
    EditableCell2.displayName = core_1.DISPLAYNAME_PREFIX + ".EditableCell2";
