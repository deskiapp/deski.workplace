...
var TruncatedFormat = /** @class */ (function (_super) {
    ...
    TruncatedFormat.prototype.renderPopover = function () {
        ...
        if (this.state.isPopoverOpen) {
            ...
            React.createElement(core_1.Popover, { className: Classes.TABLE_TRUNCATED_POPOVER_TARGET, modifiers: { preventOverflow: { boundariesElement: "window" } }, content: popoverContent, position: core_1.Position.BOTTOM, isOpen: true, onClose: this.handlePopoverClose },
