...
export interface ITableQuadrantStackProps extends Props {
     ...
     */
    columnHeaderCellRenderer?: (refHandler: IRef<HTMLDivElement>, resizeHandler: (verticalGuides: number[]) => void, reorderingHandler: (oldIndex: number, newIndex: number, length: number) => void, showFrozenColumnsOnly?: boolean) => JSX.Element;
    /**
     ...
     */
    rowHeaderCellRenderer?: (refHandler: IRef<HTMLDivElement>, resizeHandler: (verticalGuides: number[]) => void, reorderingHandler: (oldIndex: number, newIndex: number, length: number) => void, showFrozenRowsOnly?: boolean) => JSX.Element;
    /**
...
export declare class TableQuadrantStack extends AbstractComponent2<ITableQuadrantStackProps> {
    ...
    private maybeIncreaseToDefaultColumnHeaderHeight;
    /**
