...
var resizeRows_1 = require("./resizeRows");
var tableBody_1 = require("./tableBody");
var tableHotkeys_1 = require("./tableHotkeys");
...
var Table = /** @class */ (function (_super) {
    ...
    function Table(props, context) {
        ...
        _this.renderMenu = function (refHandler) {
            ...
            var classes = classnames_1.default(Classes.TABLE_MENU, (_a = {},
                _a[Classes.TABLE_SELECTION_ENABLED] = Table_1.isSelectionModeEnabled(_this.props, regions_2.RegionCardinality.FULL_TABLE),
                _a));
        ...
        _this.columnHeaderCellRenderer = function (columnIndex) {
            ...
            var columnLoading = tableUtils_1.hasLoadingOption(loadingOptions, regions_2.ColumnLoadingOption.HEADER);
        ...
        _this.renderColumnHeader = function (refHandler, resizeHandler, reorderingHandler, showFrozenColumnsOnly) {
            ...
            var classes = classnames_1.default(Classes.TABLE_COLUMN_HEADERS, (_a = {},
                _a[Classes.TABLE_SELECTION_ENABLED] = Table_1.isSelectionModeEnabled(_this.props, regions_2.RegionCardinality.FULL_COLUMNS),
                _a));
        ...
        _this.renderRowHeader = function (refHandler, resizeHandler, reorderingHandler, showFrozenRowsOnly) {
            ...
            var classes = classnames_1.default(Classes.TABLE_ROW_HEADERS, (_a = {},
                _a[Classes.TABLE_SELECTION_ENABLED] = Table_1.isSelectionModeEnabled(_this.props, regions_2.RegionCardinality.FULL_ROWS),
                _a));
            ...
            return (React.createElement("div", { className: classes, ref: refHandler },
                React.createElement(rowHeader_1.RowHeader, { enableMultipleSelection: enableMultipleSelection, focusedCell: focusedCell, grid: _this.grid, locator: _this.locator, isReorderable: enableRowReordering, isResizable: enableRowResizing, loading: tableUtils_1.hasLoadingOption(loadingOptions, regions_2.TableLoadingOption.ROW_HEADERS), maxRowHeight: maxRowHeight, minRowHeight: minRowHeight, onFocusedCell: _this.handleFocus, onLayoutLock: _this.handleLayoutLock, onResizeGuide: resizeHandler, onReordered: _this.handleRowsReordered, onReordering: reorderingHandler, onRowHeightChanged: _this.handleRowHeightChanged, onSelection: _this.getEnabledSelectionHandler(regions_2.RegionCardinality.FULL_ROWS), rowHeaderCellRenderer: rowHeaderCellRenderer, selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, rowIndexStart: rowIndexStart, rowIndexEnd: rowIndexEnd }),
        ...
        _this.bodyCellRenderer = function (rowIndex, columnIndex) {
            ...
            var id = columnProps.id, loadingOptions = columnProps.loadingOptions, cellRenderer = columnProps.cellRenderer, columnHeaderCellRenderer = columnProps.columnHeaderCellRenderer, name = columnProps.name, nameRenderer = columnProps.nameRenderer, restColumnProps = tslib_1.__rest(columnProps, ["id", "loadingOptions", "cellRenderer", "columnHeaderCellRenderer", "name", "nameRenderer"]);
            var cell = cellRenderer(rowIndex, columnIndex);
            var _a = cell.props.loading, loading = _a === void 0 ? tableUtils_1.hasLoadingOption(loadingOptions, regions_2.ColumnLoadingOption.CELLS) : _a;
            var cellProps = tslib_1.__assign(tslib_1.__assign({}, restColumnProps), { loading: loading });
        ...
        _this.renderBody = function (quadrantType, showFrozenRowsOnly, showFrozenColumnsOnly) {
            ...
            return (React.createElement("div", null,
                React.createElement(tableBody_1.TableBody, { enableMultipleSelection: enableMultipleSelection, cellRenderer: _this.bodyCellRenderer, focusedCell: focusedCell, grid: _this.grid, loading: tableUtils_1.hasLoadingOption(loadingOptions, regions_2.TableLoadingOption.CELLS), locator: _this.locator, onCompleteRender: onCompleteRender, onFocusedCell: _this.handleFocus, onSelection: _this.getEnabledSelectionHandler(regions_2.RegionCardinality.CELLS), bodyContextMenuRenderer: bodyContextMenuRenderer, renderMode: _this.getNormalizedRenderMode(), selectedRegions: selectedRegions, selectedRegionTransform: selectedRegionTransform, viewportRect: viewportRect, columnIndexStart: columnIndexStart, columnIndexEnd: columnIndexEnd, rowIndexStart: rowIndexStart, rowIndexEnd: rowIndexEnd, numFrozenColumns: showFrozenColumnsOnly ? numFrozenColumns : undefined, numFrozenRows: showFrozenRowsOnly ? numFrozenRows : undefined }),
        ...
        _this.state = {
            ...
            isReordering: false,
            numFrozenColumnsClamped: tableUtils_1.clampNumFrozenColumns(props),
            numFrozenRowsClamped: tableUtils_1.clampNumFrozenRows(props),
            rowHeights: newRowHeights,
            selectedRegions: selectedRegions,
        };
        _this.hotkeysImpl = new tableHotkeys_1.TableHotkeys(props, _this.state, _this.grid, {
    ...
    Table.getDerivedStateFromProps = function (props, state) {
        ...
        if (!core_1.Utils.deepCompareKeys(state, nextState, Table_1.SHALLOW_COMPARE_STATE_KEYS_DENYLIST)) {
            return nextState;
        }
        return null;
    };
    ...
    Table.prototype.resizeRowsByApproximateHeight = function (getCellText, options) {
        var rowHeights = resizeRows_1.resizeRowsByApproximateHeight(this.props.numRows, this.state.columnWidths, getCellText, options);
        this.invalidateGrid();
    ...
    Table.prototype.resizeRowsByTallestCell = function (columnIndices) {
        var rowHeights = resizeRows_1.resizeRowsByTallestCell(this.grid, this.state.viewportRect, this.locator, this.state.rowHeights.length, columnIndices);
        this.invalidateGrid();
        this.setState({ rowHeights: rowHeights });
    };
    /**
    ...
    Table.prototype.shouldComponentUpdate = function (nextProps, nextState) {
        ...
        return (!core_1.Utils.shallowCompareKeys(this.props, nextProps, propKeysDenylist) ||
            ...
            !core_1.Utils.deepCompareKeys(this.props, nextProps, Table_1.SHALLOW_COMPARE_PROP_KEYS_DENYLIST) ||
            !core_1.Utils.deepCompareKeys(this.state, nextState, Table_1.SHALLOW_COMPARE_STATE_KEYS_DENYLIST));
    };
    Table.prototype.render = function () {
        ...
        var classes = classnames_1.default(Classes.TABLE_CONTAINER, (_a = {},
            ...
            _a[Classes.TABLE_SELECTION_ENABLED] = Table_1.isSelectionModeEnabled(this.props, regions_2.RegionCardinality.CELLS),
    ...
    Table.prototype.componentDidUpdate = function (prevProps, prevState, snapshot) {
        ...
        var didUpdateColumnOrRowSizes = !core_1.Utils.arraysEqual(this.state.columnWidths, prevState.columnWidths) ||
            !core_1.Utils.arraysEqual(this.state.rowHeights, prevState.rowHeights);
    ...
    Table.prototype.maybeRenderCopyHotkey = function () {
        ...
        if (getCellClipboardData != null) {
            return (React.createElement(core_1.Hotkey, { key: "copy-hotkey", label: "Copy selected table cells", group: "Table", combo: "mod+c", onKeyDown: this.hotkeysImpl.handleCopy }));
        }
        else {
            return undefined;
        }
    ...
    Table.prototype.maybeRenderSelectionResizeHotkeys = function () {
        ...
        if (enableMultipleSelection && isSomeSelectionModeEnabled) {
            return [
                React.createElement(core_1.Hotkey, { key: "resize-selection-up", label: "Resize selection upward", group: "Table", combo: "shift+up", onKeyDown: this.hotkeysImpl.handleSelectionResizeUp }),
                React.createElement(core_1.Hotkey, { key: "resize-selection-down", label: "Resize selection downward", group: "Table", combo: "shift+down", onKeyDown: this.hotkeysImpl.handleSelectionResizeDown }),
                React.createElement(core_1.Hotkey, { key: "resize-selection-left", label: "Resize selection leftward", group: "Table", combo: "shift+left", onKeyDown: this.hotkeysImpl.handleSelectionResizeLeft }),
                React.createElement(core_1.Hotkey, { key: "resize-selection-right", label: "Resize selection rightward", group: "Table", combo: "shift+right", onKeyDown: this.hotkeysImpl.handleSelectionResizeRight }),
            ];
        }
        else {
            return undefined;
    ...
    Table.prototype.maybeRenderFocusHotkeys = function () {
        ...
        if (enableFocusedCell != null) {
            return [
                React.createElement(core_1.Hotkey, { key: "move left", label: "Move focus cell left", group: "Table", combo: "left", onKeyDown: this.hotkeysImpl.handleFocusMoveLeft }),
                React.createElement(core_1.Hotkey, { key: "move right", label: "Move focus cell right", group: "Table", combo: "right", onKeyDown: this.hotkeysImpl.handleFocusMoveRight }),
                React.createElement(core_1.Hotkey, { key: "move up", label: "Move focus cell up", group: "Table", combo: "up", onKeyDown: this.hotkeysImpl.handleFocusMoveUp }),
                React.createElement(core_1.Hotkey, { key: "move down", label: "Move focus cell down", group: "Table", combo: "down", onKeyDown: this.hotkeysImpl.handleFocusMoveDown }),
                React.createElement(core_1.Hotkey, { key: "move tab", label: "Move focus cell tab", group: "Table", combo: "tab", onKeyDown: this.hotkeysImpl.handleFocusMoveRightInternal, allowInInput: true }),
                React.createElement(core_1.Hotkey, { key: "move shift-tab", label: "Move focus cell shift tab", group: "Table", combo: "shift+tab", onKeyDown: this.hotkeysImpl.handleFocusMoveLeftInternal, allowInInput: true }),
                React.createElement(core_1.Hotkey, { key: "move enter", label: "Move focus cell enter", group: "Table", combo: "enter", onKeyDown: this.hotkeysImpl.handleFocusMoveDownInternal, allowInInput: true }),
                React.createElement(core_1.Hotkey, { key: "move shift-enter", label: "Move focus cell shift enter", group: "Table", combo: "shift+enter", onKeyDown: this.hotkeysImpl.handleFocusMoveUpInternal, allowInInput: true }),
            ];
        }
        else {
            return [];
    ...
    Table.prototype.maybeRenderSelectAllHotkey = function () {
        if (Table_1.isSelectionModeEnabled(this.props, regions_2.RegionCardinality.FULL_TABLE)) {
            return (React.createElement(core_1.Hotkey, { key: "select-all-hotkey", label: "Select all", group: "Table", combo: "mod+a", onKeyDown: this.hotkeysImpl.handleSelectAllHotkey }));
        }
        else {
            return undefined;
        }
    ...
    Table.prototype.shouldDisableVerticalScroll = function () {
        ...
        var areRowHeadersLoading = tableUtils_1.hasLoadingOption(this.props.loadingOptions, regions_2.TableLoadingOption.ROW_HEADERS);
    ...
    Table.prototype.shouldDisableHorizontalScroll = function () {
        ...
        var areColumnHeadersLoading = tableUtils_1.hasLoadingOption(this.props.loadingOptions, regions_2.TableLoadingOption.COLUMN_HEADERS);
