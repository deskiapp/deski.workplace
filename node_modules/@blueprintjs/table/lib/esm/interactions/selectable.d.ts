...
export declare type ISelectedRegionTransform = (region: Region, event: MouseEvent | KeyboardEvent, coords?: ICoordinateData) => Region;
export declare type SelectedRegionTransform = ISelectedRegionTransform;
